Class Gamespy_Encoder
    ...
    Private Sub encshare4(ByRef src As Byte(), ByVal size As Integer, ByRef dest As UInteger())
        Dim tmp As UInteger
    ...
    Private Function SumaOverF(ByVal a As ULong, ByVal b As ULong) As UInteger
        Dim res As ULong = a + b
        res = res Mod 4294967296
        Return res
    End Function

    Private Sub encshare3(ByRef data As UInteger(), ByVal n1 As Integer, ByVal n2 As Integer)
        Dim t1 As UInteger
        Dim t2 As UInteger
        Dim t3 As UInteger
        Dim t4 As UInteger
    ...
    Private p_ind As Integer
    Private Sub encshare1(ByVal tbuff() As UInteger, ByRef datap() As Byte, ByVal len As Integer)
        p_ind = 309
    ...
    Private Sub encshare2(ByRef tbuff() As UInteger, ByVal len As Integer)
        Dim t1 As UInteger
        Dim t2 As UInteger
        Dim t3 As UInteger
        Dim t4 As UInteger
...
Class Gamespy_Decoder 'courtesy of NFBSP
    Public Function enctype2_decoder(ByVal data() As Byte, ByVal datalength As Integer, ByVal key As String) As String
    ...
    End Function
    Private p_ind As Integer
    Private Function encshare1(ByVal tbuff() As UInteger, ByVal datap() As Byte, ByVal len As Integer) As Byte()
        p_ind = 309
        Dim s_ind As Integer = 309
    ...
    Private Function SumaOverF(ByVal a As ULong, ByVal b As ULong) As UInteger
        ...
        Return res
    End Function
    Private Function encshare3(ByVal data() As UInteger, ByVal n1 As Integer, ByVal n2 As Integer)
        Dim t1 As UInteger
        Dim t2 As UInteger
        Dim t3 As UInteger
        Dim t4 As UInteger
        ...
        Return data
    End Function
    Private Function encshare4(ByVal data() As Byte, ByVal dest() As UInteger) As UInteger()
        ...
        Return dest
    End Function
    Private Function encshare2(ByVal tbuff() As UInteger, ByVal len As Integer) As UInteger()
        Dim t1 As UInteger
        Dim t2 As UInteger
        Dim t3 As UInteger
        Dim t4 As UInteger
